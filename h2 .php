...
text-align:center;}
    ...
    $sql="SELECT img,stock,title, cost, book_id,name,published_date FROM books inner join publishers on publishers.publisher_id=books.publisher_id and book_id>229 limit 8";
...
<div class="login-form-container">
    ...
    <section>
            ...
            <?php
            $result=pg_query($con,$sql);//printing everything from table using the attributes from $result
            ?>
			...
			<a class="next" href='home 1.php'>PREV>> </a>
</section>
